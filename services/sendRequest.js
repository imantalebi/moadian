...
function sendRequest(url_1) {
    return __awaiter(this, arguments, void 0, function (url, method, token, body) {
        var result, headers, postData;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    postData = [body];
                    result = axios_1.default.post(url, postData, { headers: headers }).then(function (res) {

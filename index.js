...
var jws_js_1 = require("./services/jws.js");
var uuid_1 = require("uuid");
var sendRequest_js_1 = require("./services/sendRequest.js");
var moment = require("moment");
var verhoeff_js_1 = require("./services/verhoeff.js");
var jwe_js_1 = require("./services/jwe.js");
var moadian = /** @class */ (function () {
    ...
    moadian.prototype.requestNonce = function () {
        return (0, sendRequest_js_1.default)(this.apiBaseUrl + '/nonce?timeToLive=' + Math.floor(Math.random() * 180 + 20));
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, jws_js_1.default)(this.privateKey, jwsHeader, data)];
                    case 2:
                        token = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, (0, sendRequest_js_1.default)(this.apiBaseUrl + '/server-information', 'GET', token)];
                    case 2:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        result = (0, sendRequest_js_1.default)(this.apiBaseUrl + '/invoice', 'POST', token, invoicesPackets);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, jws_js_1.default)(this.privateKey, jwsHeader, { 'header': invoiceHeader, 'body': invoiceBody, 'payments': invoicePayment })];
                    case 2:
                        invoiceJWS = _a.sent();
                        jweHeader = {
                            'alg': 'RSA-OAEP-256',
                        ...
                        return [4 /*yield*/, (0, jwe_js_1.default)(jweHeader, serverPublicKey, invoiceJWS)];
                    case 3:
                        payload = _a.sent();
                        data = {
                            'payload': payload,
    ...
    moadian.prototype.generateInvoiceId = function (date, internalInvoiceId) {
        ...
        var checksum = (0, verhoeff_js_1.default)(decimalInvoiceId);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        params += '&uidList=' + UIds;
                        result = (0, sendRequest_js_1.default)(this.apiBaseUrl + '/inquiry-by-uid?' + params, 'GET', token);
                        return [2 /*return*/, result];
                }
            });
        });
